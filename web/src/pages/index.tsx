...
import appPreviewImg from '../assets/iphones-preview.png'
import logoImg from '../assets/logo.svg'
import usersAvatarExampleImg from '../assets/users.png' 
import iconChecking from '../assets/checked-icon.svg'
   ...
   <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
    <main>
      ...
      <form onSubmit={createPool} className='mt-10 flex gap-2'>
        ...
        />
        <button 
        className='bg-yellow-500 px-6 py-4 rounded text-gray-900 font-bold text-sm uppercase hover:bg-yellow-300' 
      ...
      <div className='mt-10 pt-10 border-t border-gray-600 flex items-center justify-between text-gray-100'>
        <div className='flex items-center gap-6'>
          <Image src={iconChecking} alt="Icone de check"/>
    ...
    <Image
      src={appPreviewImg}
      alt="Dois iphones mostrando a preview do NLW Copa"
      quality={100}
    />
